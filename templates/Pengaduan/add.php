...
<div class="card card-primary card-outline">
    ...
    <div class="card-body">
        ...
        <?= $this->Form->control('images', ['type'=>'file', 'require'=> true]) ?>
        <?= $this->Form->control('status',['value'=>'0']) ?>
        <?= $this->Form->control('petugas_id', ['class' => 'form-control', 'value' => $this->Identity->get('id'), 'type' => 'hidden']) ?>
    </div>
